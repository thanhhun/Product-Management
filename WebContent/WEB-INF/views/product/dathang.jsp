...
<body class="">
	...
	<div class="page-wrapper">
		...
		<div class="page-content">
						...
						<tbody>
							<c:forEach var="pd" items="${datHangs}">
									<tr>
										...
										<td>${pd.kho.maKho}</td>
										<td><a
											href="product/dathang/chitiet/${pd.masoDDH.trim()}/${id_NV}.htm">Chi
												tiết</a></td>
										<td><a class="btnEdit"
											href="product/dathang/${pd.masoDDH.trim()}/${id_NV}.htm?lnkEdit"><i
												class="ti-settings"></i></a></td>
										<td><a class="btnDelete"
											href="product/dathang/${pd.masoDDH.trim()}/${id_NV}.htm?lnkDel"><i
						...
						<div class="card">
							<div class="card-header">
								<div class="row align-items-center">
									<div class="col">
										<h4 class="card-title">Lập đơn đặt hàng</h4>
									</div>
									<!--end col-->
								</div>
								<!--end row-->
							...
							<div class="card-body">
								...
								<form:form action="product/dathang/action/${id_NV}.htm"
									...
									<div class="form-group row">
										<label
											...
											DDH</label>
										<div class="col-lg-9 col-xl-8">
											<form:input path="masoDDH" class="form-control" type="text" />
										</div>
									</div>
									<div class="form-group row">
										<label
											class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">Nhà cung cấp</label>
										<div class="col-lg-9 col-xl-8">
											<form:input path="nhaCC" class="form-control" type="text" />
										</div>
									</div>
									<div class="form-group row">
										<label
			...
			<c:if test="${clickaction =='showCTDDH'}">
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="card">
							...
							<div class="card-body">
								...
								<form:form
									action="product/dathang/action/chitiet/${id_NV}.htm"
									modelAttribute="chitietdathang">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-8">
											<form:input path="datHang.masoDDH" class="form-control"
												type="text" value="${masoDDH}" readonly="true" />
										</div>
									</div>
									<div class="form-group row">
										<label
									...
									<div class="form-group row">
										<div class="col-lg-9 col-xl-8 offset-lg-3">
											...
											<button formaction="product/dathang/${id_NV}.htm"
					...
					<div class="col-lg-9">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">
									Chi tiết đơn đặt hàng của mã <strong>${masoDDH}</strong>
								</h4>
							</div>
							<!--end card-header-->
							<div class="card-body">
										...
										<tbody>
											<c:forEach var="c" items="${CTDDHs}">
												<tr>
													...
													<td>${c.donGia}</td>
													<td><a class="btnEdit"
														href="product/dathang/chitiet/${c.datHang.masoDDH}/${c.vatTu.maVT}/${id_NV}.htm?lnkEdit"><i
															class="ti-settings"></i></a></td>
													<td><a class="btnDelete"
														href="product/dathang/chitiet/${c.datHang.masoDDH}/${c.vatTu.maVT}/${id_NV}.htm?lnkDel"><i
															class="ti-trash"></i></a></td>
												</tr>
											</c:forEach>
										</tbody>
